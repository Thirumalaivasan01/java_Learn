...
public class Home {
	...
	public static void showAllSongs(ArrayList<MusicFiles> list) {
		for (MusicFiles musicFiles : list) {
			// System.out.format("%40 %40 %40 %40 %40 %40", musicFiles.getSong_Id(),
			// musicFiles.getSong_Title(),
			// musicFiles.getArtist_Name(), musicFiles.getAlbum_Name(),
			// musicFiles.getSong_Location(),
